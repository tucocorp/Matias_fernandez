...
function(module) {
  ...
  var resetLabels = countdown.resetLabels = function() {
    LABELS_SINGLUAR = 'millisegundo|segundo|minuto|hora|día|semana|mes|año|decada|siglo|milenio'.split('|');
    LABELS_PLURAL = 'millisegundos|segundos|minutos|horas|días|semanas|meses|años|decadas|siglos|milenios'.split('|');
  };
